...
export declare const ROLES_OBSERVADOR: readonly RolObservador[];
/** Observadores internos: directivo par, docentes, administrativos. */
export declare const ROLES_INTERNOS: readonly RolObservador[];
/** Observadores externos: acudientes, estudiantes. */
export declare const ROLES_EXTERNOS: readonly RolObservador[];
/** Tipo de formulario tal como se guarda con cada respuesta. */
export type TipoFormulario = "autoevaluacion" | "directivo" | "docente" | "administrativo" | "acudiente" | "estudiante";
export declare const ROL_DE_FORMULARIO: Readonly<Record<Exclude<TipoFormulario, "autoevaluacion">, RolObservador>>;
